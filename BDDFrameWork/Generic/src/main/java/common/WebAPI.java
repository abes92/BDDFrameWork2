    ...
    public WebDriver getLocalDriver(@Optional("mac") String OS, String browserName) {
        if (browserName.equalsIgnoreCase("chrome")) {
            if (OS.equalsIgnoreCase("OS X")) {
                System.setProperty("webdriver.chrome.driver", "/Users/abestaieb/LearnWebAutomationFramework_WeekendAfternoon_Selenium_NY_Summer2020/LearnBDDWebAutomationFramework_WeekendAfternoon_Selenium_NY_Summer2020/second/Generic/BrowserDriver/mac/chromedriver");
